...
There are terminal commands and git commands. Here are some useful commands for terminal (% is prompt and not part of the command):
...
5. Navigate to your folder by entering the following command:

```
% cd <yourName>
```
6. Make sure to confirm that you have Git installed. You can do this by running the following git command in Terminal:
```
% git --version
```
...
7. Once you have Git installed we need to customize the environment:
